...
class TemplateControllerApi(object):
    ...
    def delete_template_with_http_info(self, template_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/template/v1/templates/{templateId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def download_code_from_template(self, body, template_id, **kwargs):  # noqa: E501
        """download_code_from_template  # noqa: E501

        Download code by template id and the given template variables  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_code_from_template(body, template_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GenerateDownloadRepositoryDto body: (required)
        :param str template_id: ID of the template (e.g. bed84f43-fefd-4461-a864-16367ea25dd9) (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.download_code_from_template_with_http_info(body, template_id, **kwargs)  # noqa: E501
        else:
            (data) = self.download_code_from_template_with_http_info(body, template_id, **kwargs)  # noqa: E501
            return data

    def download_code_from_template_with_http_info(self, body, template_id, **kwargs):  # noqa: E501
        """download_code_from_template  # noqa: E501

        Download code by template id and the given template variables  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_code_from_template_with_http_info(body, template_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_code_from_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `download_code_from_template`")  # noqa: E501
        # verify the required parameter 'template_id' is set
        if ('template_id' not in params or
                params['template_id'] is None):
            raise ValueError("Missing the required parameter `template_id` when calling `download_code_from_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/template/v1/templates/{templateId}/download', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
